            ...
            <el-row style="padding: 10px 20px 20px 20px;">
                ...
                <el-row>
                    <p style="font-size: 12px;padding: 3px 0;">
                        <span class="modelName">*使用者名稱</span>
                    </p>
                    <input class="input-title" v-model="userInfo.name" placeholder="使用者名稱">
                </el-row>
                <el-row>
                    <p style="font-size: 12px;padding: 3px 0;">
                        <span class="modelName">*使用者信箱</span>
                    </p>
                    <input class="input-title" v-model="userInfo.email" placeholder="使用者信箱">
                </el-row>
            </el-row>
            <span slot="footer" class="dialog-footer">
                <el-button class="customer" size="small" style="background-color: rgb(241, 241, 241);border: none;"
                    @click="dialogOperaion = false">取消</el-button>
    ...
    methods: {
        ...
        async tokenCheckLoad() {
            try {
                ...
                console.error('取得使用者驗證資訊時發生錯誤:', error);
                this.$message.error('驗證資訊載入失敗，請重試！');
            }
        },
    }
};
